...
gross_revenue_comparison = data[['Date', '%± LD']]
...
gross_revenue_comparison['%± LD'] = gross_revenue_comparison['%± LD'].apply(pd.to_numeric, errors='coerce')
plt.figure(figsize=(10,5))
plt.plot(gross_revenue_comparison['Date'], gross_revenue_comparison['%± LD'])
plt.xlabel('Date')
